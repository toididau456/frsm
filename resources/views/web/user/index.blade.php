...
<div class="col-md-9" id="content">
    <div class="row">
        <div class="panel panel-primary table-filterable table-filterable-user col-md-12" data-url="{{ action('Web\UserController@filter') }}">
            ...
            <div class="table user">
                <table class="table">
                    ...
                    <tr class="filters table-filterable-inputs" >
                        <th>{{ trans('messages.name') }}<input name="name" type="text" id="name" class="form-control"></th>
                        <th>{{ trans('messages.email') }}<input name="email" type="text" id="email" class="form-control"></th>
                        <th>{{ trans('messages.position') }}
